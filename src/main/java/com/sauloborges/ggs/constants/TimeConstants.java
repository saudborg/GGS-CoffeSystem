...
public class TimeConstants {
	...
	public static final Integer HALF_SECOND = 500; // 0.5 Seconds
	...
	public static final Integer PICKING_THE_TYPE = QUARTER_SECOND;
	public static final Integer GETTING_THE_CUP = QUARTER_SECOND;
